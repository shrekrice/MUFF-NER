...
def get_ner_fmeasure(golden_lists, predict_lists, label_type="example_BMES.dev",printnum=True):
    ...
    for idx in range(0,sent_num):
        ...
        if label_type == "example_BMES.dev":
...
def fmeasure_from_file(golden_file, predict_file, label_type="example_BMES.dev"):
...
def fmeasure_from_singlefile(twolabel_file, label_type="example_BMES.dev", pred_col=-1):
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 3:
        fmeasure_from_singlefile(sys.argv[1],"example_BMES.dev",int(sys.argv[2]))
    else:
        fmeasure_from_singlefile(sys.argv[1],"example_BMES.dev")
